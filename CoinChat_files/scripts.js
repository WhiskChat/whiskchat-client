...
socket.on("chat", function(data){
    ...
    if (data.message.substr(0, 56) == "<span class='label label-success'>has tipped whiskers75 " && data.user != "WhiskDiceBot" && data.message.indexOf('message: WhiskChat client donation')) {
