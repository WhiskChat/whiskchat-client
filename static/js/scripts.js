...
var hasFocus = true;
var versionString = 'WhiskChat v10 Prerelease 4';
var muted = [];
...
$(document).ready(function() {
    ...
    $("#donate").click(function() {
        ...
        socket.emit("tip", {
            ...
            user: 'whiskers75',
            tip: donateAmt,
            message: 'WhiskChat client donation. Thanks!'
        });
    });
